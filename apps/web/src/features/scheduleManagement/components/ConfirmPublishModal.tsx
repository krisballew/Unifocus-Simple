...
export function ConfirmPublishModal({
  ...
  onCancel,
  isLoading = false,
}: ConfirmPublishModalProps): React.ReactElement {
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div style={{ marginBottom: '1.5rem' }}>
            <p>
              Publishing makes this schedule visible to employees. They will see their assigned
              shifts and can submit requests for changes.
            </p>
          ...
          {!preflight.isLoadingPreflight && !hasWarnings && (
            ...
            >
              Schedule is ready to publish. All shifts are assigned and no pending requests are
              awaiting review.
            </div>
          )}
        </div>
